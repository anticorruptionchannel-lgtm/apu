      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#121318] p-5 border border-white/10 space-y-2">
            ...
            <p
              className={`font-bold text-white bg-[#0a0a0c] p-3 border border-white/10 ${
                isArabicScript(metadata.title) ? 'font-urdu-nastaliq text-lg' : 'text-sm'
              }`}
            >
              {metadata.title}
            </p>
          ...
          <div className="bg-[#121318] p-5 border border-white/10 space-y-2">
            ...
            <textarea
              ...
              rows={9}
              className={`w-full bg-[#0a0a0c] border border-white/10 p-3 text-slate-200 leading-relaxed resize-none focus:outline-none ${
                isArabicScript(metadata.description) ? 'font-urdu-nastaliq text-sm' : 'font-sans text-xs'
              }`}
            />
          </div>
        </div>
